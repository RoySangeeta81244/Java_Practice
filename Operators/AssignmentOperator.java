...
public class AssignmentOperator {
    public static void main(String[] args) {
        //Plusequal +=
        int number = 10;
        number += 5;// number = number +5 = 15(10+5)
       ...
       int result = 20;
        ...
        //Minusequal -=
        int marks = 90;  
        marks -= 30; //marks = marks -30 = 60(90-30)
        ...
        //Multiplyequal *=
        int level = 95;
        level *= 5;  //level = level *5 = 475(95*5)
        ...
        score /= 5;  // divisor   score = score/5 =10(50/5)   
        ...
        value %= 6; // divisor   value = value%6 = 2(56%6)
